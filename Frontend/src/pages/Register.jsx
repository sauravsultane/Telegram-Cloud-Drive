...
import { Cloud, Mail, Lock, User, Eye, EyeOff, ArrowRight, AlertCircle } from 'lucide-react';
...
const Register = () => {
  ...
  const getPasswordStrength = () => {
    ...
    if (password.length < 6) return { width: '50%', color: 'bg-amber-400', label: 'Fair' };
    if (password.length < 8) return { width: '75%', color: 'bg-blue-400', label: 'Good' };
        ...
        <div className="bg-white dark:bg-[#1a1d27] rounded-[28px] border border-gray-100 dark:border-gray-800/60 shadow-[0_8px_40px_rgba(0,0,0,0.06)] dark:shadow-[0_8px_40px_rgba(0,0,0,0.3)] p-10 transition-colors duration-300">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-gray-400 dark:text-gray-500 text-sm mt-1.5">
              Start storing files securely with TeleDrive
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                  <User size={17} className="text-gray-300 dark:text-gray-600 group-focus-within:text-[#1967d2] transition-colors" />
                </div>
                <input
                  type="text"
                  value={firstName}
                  onChange={(e) => setFirstName(e.target.value)}
                  className="w-full bg-gray-50/70 dark:bg-[#12141c] border border-gray-200 dark:border-gray-700/60 rounded-xl py-3 pl-10.5 pr-4 text-gray-800 dark:text-white text-[15px] placeholder:text-gray-300 dark:placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-[#1967d2]/20 focus:border-[#1967d2] dark:focus:border-blue-500 transition-all duration-200"
            ...
            <div>
              ...
              {password && (
                <div className="mt-2.5 flex items-center gap-3">
                  ...
                  <span className="text-xs font-medium text-gray-400 dark:text-gray-500 min-w-[42px]">
                    {strength.label}
                  </span>
                </div>
              )}
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 leading-relaxed">
              ...
              <span className="text-[#1967d2] dark:text-blue-400 cursor-pointer hover:underline">Terms of Service</span>
              {' '}and{' '}
              <span className="text-[#1967d2] dark:text-blue-400 cursor-pointer hover:underline">Privacy Policy</span>.
            </p>
          ...
          <p className="mt-8 text-center text-sm text-gray-400 dark:text-gray-500">
            ...
            <Link to="/login" className="text-[#1967d2] dark:text-blue-400 font-semibold hover:text-[#1557b0] dark:hover:text-blue-300 transition-colors">
              Log in
            </Link>
          </p>
        </div>
